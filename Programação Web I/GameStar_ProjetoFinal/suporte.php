      ...
      function mostrarFormularioResposta(id) {
        ...
        <div class="col-lg-7 mb-3 mt-1">
          <div class="feedback">
            ...
            <h2 class="text-center"><strong>Para acionar o suporte</strong></h2>
            <h4 class="text-center">E tenha suas dúvidas respondidas!</h4>
            <img src="Imagens/Imagens/service-247-animate.svg" alt="">
          </div>
        </div>
      </div>
    </div>
